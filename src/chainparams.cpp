...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256S("000003abe3ecfc16d4e6c7660b5242dece293abec985129e291317931b01e77c"))
    ;

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1614728933, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1614728933, 684403, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000003abe3ecfc16d4e6c7660b5242dece293abec985129e291317931b01e77c"));
        assert(genesis.hashMerkleRoot == uint256S("0x98dfc3d1b7d27b9d5c4519004cefd08415cf0ee628585f207add2f295d0d1c30"));
