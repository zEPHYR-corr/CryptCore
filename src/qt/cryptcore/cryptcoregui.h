...
#ifndef Cryptcore_CORE_NEW_GUI_CryptcoreGUI_H
#define Cryptcore_CORE_NEW_GUI_CryptcoreGUI_H
...
#include "qt/cryptcore/navmenuwidget.h"
#include "qt/cryptcore/topbar.h"
#include "qt/cryptcore/dashboardwidget.h"
#include "qt/cryptcore/send.h"
#include "qt/cryptcore/receivewidget.h"
#include "qt/cryptcore/addresseswidget.h"
#include "qt/cryptcore/coldstakingwidget.h"
#include "qt/cryptcore/masternodeswidget.h"
#include "qt/cryptcore/snackbar.h"
#include "qt/cryptcore/settings/settingswidget.h"
...
/**
  Cryptcore GUI main class. This class represents the main window of the Cryptcore UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class CryptcoreGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit CryptcoreGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~CryptcoreGUI();
...
#endif //Cryptcore_CORE_NEW_GUI_CryptcoreGUI_H
