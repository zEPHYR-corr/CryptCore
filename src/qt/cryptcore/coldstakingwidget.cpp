...
#include "qt/cryptcore/forms/ui_coldstakingwidget.h"
#include "qt/cryptcore/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/cryptcore/requestdialog.h"
...
ColdStakingWidget::ColdStakingWidget(CryptcoreGUI* parent) :
    PWidget(parent),
