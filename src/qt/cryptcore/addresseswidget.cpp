...
#include "qt/cryptcore/forms/ui_addresseswidget.h"
#include "qt/cryptcore/addresslabelrow.h"
#include "qt/cryptcore/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(CryptcoreGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination corrAdd = DecodeDestination(address.toUtf8().constData(), isStakingAddress);
        ...
        if (walletModel->updateAddressBookLabels(corrAdd, label.toUtf8().constData(),
