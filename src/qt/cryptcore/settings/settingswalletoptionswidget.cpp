...
#include "qt/cryptcore/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/cryptcore/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(CryptcoreGUI* _window, QWidget *parent) :
