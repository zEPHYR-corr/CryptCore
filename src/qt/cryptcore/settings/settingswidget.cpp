...
#include "qt/cryptcore/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(CryptcoreGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &CryptcoreGUI::openFAQ);
