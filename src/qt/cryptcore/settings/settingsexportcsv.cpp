...
#include "qt/cryptcore/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(CryptcoreGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("Cryptcore_tx_csv_export(*.csv)") : tr("Cryptcore_addresses_csv_export(*.csv)"),
                                        nullptr);
