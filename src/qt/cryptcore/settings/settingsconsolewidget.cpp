...
#include "qt/cryptcore/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/cryptcore/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(CryptcoreGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
	...
	message(CMD_REPLY, (tr("Welcome to the Cryptcore Coin RPC console.") + "<br>" +
