...
#include "qt/cryptcore/settings/settingsnetworkwidget.h"
#include "qt/cryptcore/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/cryptcore/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(CryptcoreGUI* _window, QWidget *parent) :
