...
#include "qt/cryptcore/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/cryptcore/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(CryptcoreGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to CryptcoreGUI::handleRestart()
