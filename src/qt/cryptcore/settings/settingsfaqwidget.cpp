...
#include "qt/cryptcore/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/cryptcore/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(CryptcoreGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableCORR,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableCORR,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableCORR,
    ...
    connect(ui->pushButton_UnspendableCORR, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableCORR);});
    ...
    if (parent)
        connect(parent, &CryptcoreGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
