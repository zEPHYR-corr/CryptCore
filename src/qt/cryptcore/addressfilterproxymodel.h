...
#ifndef Cryptcore_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define Cryptcore_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //Cryptcore_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
