...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, CryptcoreGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, CryptcoreGUI* gui, double posX = 3);
