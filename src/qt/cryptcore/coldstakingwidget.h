...
#include "qt/cryptcore/furabstractlistitemdelegate.h"
#include "qt/cryptcore/txviewholder.h"
#include "qt/cryptcore/tooltipmenu.h"
#include "qt/cryptcore/sendmultirow.h"
#include "qt/cryptcore/coldstakingmodel.h"
...
public:
    explicit ColdStakingWidget(CryptcoreGUI* parent);
    ~ColdStakingWidget();
