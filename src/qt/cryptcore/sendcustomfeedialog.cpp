...
#include "qt/cryptcore/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(CryptcoreGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &CryptcoreGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
