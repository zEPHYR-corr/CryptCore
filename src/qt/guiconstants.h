...
#define QAPP_ORG_NAME "Cryptcore Coin"
#define QAPP_ORG_DOMAIN "cryptcore.trade"
#define QAPP_APP_NAME_DEFAULT "Cryptcore Coin-Qt"
#define QAPP_APP_NAME_TESTNET "Cryptcore Coin-Qt-testnet"
