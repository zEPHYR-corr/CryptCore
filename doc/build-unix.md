UNIX BUILD NOTES
====================
Some notes on how to build Cryptcore in Unix.

Note
---------------------
Always use absolute paths to configure and compile Cryptcore and the dependencies,
...
memory available when compiling Cryptcore. On systems with less, gcc can be
 ...
 **For Ubuntu only:** db4.8 packages are available [here](https://launchpad.net/~cryptcore/+archive/cryptcore).
 You can add the repository using the following command:

    sudo apt-get install software-properties-common
    sudo add-apt-repository ppa:cryptcore/cryptcore
    sudo apt-get update
...
To build Cryptcore without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
Security
--------
To help make your Cryptcore installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, Cryptcore should be built with a non-executable stack
