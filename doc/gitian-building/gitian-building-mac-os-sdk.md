...
The script [extract-osx-sdk.sh](https://github.com/cryptcore-project/cryptcore/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
cryptcore/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/cryptcore-project/cryptcore/blob/master/doc/README_osx.md) for troubleshooting tips.
