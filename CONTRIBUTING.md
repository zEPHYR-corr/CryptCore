Contributing to Cryptcore
============================

The Cryptcore project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/cryptcore-project/cryptcore/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Cryptcore project, and is not to be
confused with overall Cryptcore Network Protocol consensus changes.

Whether a pull request is merged into Cryptcore rests with the project merge
...
Patches that change Cryptcore consensus rules are considerably more involved than
...
Where a patchset proposes to change the Cryptcore consensus, it must have been
...
The project leader is the release manager for each Cryptcore release.
